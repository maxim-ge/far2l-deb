...
- SFTP/SMB клиент NetRocks на базе libssh/libsmbclient (в преспективе планируются и другие протоколы)
...
- libssh/libsmbclient-based Netrocks SFTP/SMB client (other protocols are planned as well)
